...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $eventTitle = isset($_POST['eventTitle']) ? $_POST['eventTitle'] : 'Evento desconhecido';
...
if (curl_errno($ch)) {
    ...
    if ($httpStatus == 201) {
        ...
        $message = "Erro ao salvar a inscrição. Status HTTP: $httpStatus <br> Resposta do servidor Node: " . htmlspecialchars($response);
    }
}
...
<!-- botao pra voltar pro calendario -->
 <div class="button-container" style="text-align:center; margin-top: 20px;">
    <a href="../php/index.php" class="btn btn-success">Voltar para lista de eventos</a>
</div>
